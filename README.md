...
## CSS
- [Práctica 1: Box Model]
- [Práctica 2: Botones]
- [Asignación Core 1: Nuevos Bloques]
- [Práctica 3: ¡Cambiémos a Flex!]
- [Asignación Core 2: Diseño con Imagenes]
- [Asignación Core 3: Tarjeta de Usuario]
- [Asignación Core 4: Página de Perfil]
